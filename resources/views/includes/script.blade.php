...
<script>
    ...
    function search() {
        ...
        if (window.location.pathname == "/nota-dinas") {
            $.post('{{ route('officialmemo.search') }}', {
            ...
            $.post('{{ route('outgoingmail.search') }}', {
                    _token: $('meta[name="csrf-token"]').attr('content'),
                    keyword: keyword
                },
                function(data) {
            ...
            $.post('{{ route('documentauthorizationletter.search') }}', {
                    _token: $('meta[name="csrf-token"]').attr('content'),
                    keyword: keyword
                },
                function(data) {
                    ...
                    htmlView += `
                        ...
                        <td>
                            <div class="d-flex align-items-center justify-content-center">
                                <a href="{{ url('/nota-dinas/` + item.id +`') }}"><button type="button"
                                    ...
                                    <a href="{{ url('/nota-dinas/ubah/` + item.id +`') }}" class="mx-1"><button
            ...
            callback: function(data, pagination) {
                ...
                $.each(data, function(index, item) {
                    htmlView += `
                        ...
                        <td>
                            <div class="d-flex align-items-center justify-content-center">
                                <a href="{{ url('/berita-acara/` + item.id +`') }}"><button type="button"
                                        class="btn btn-primary btn-sm">
                                        <svg xmlns="http://www.w3.org/2000/svg" height="1em"
                                            viewBox="0 0 576 512">
                                            <style>
                                    ...
                                    <a href="{{ url('/berita-acara/ubah/` + item.id +`') }}" class="mx-1"><button
                                            type="button" class="btn btn-warning btn-sm">
                                            <svg xmlns="http://www.w3.org/2000/svg" height="1em"
                                                viewBox="0 0 512 512">
                                                <style>
            ...
            callback: function(data, pagination) {
                ...
                $.each(data, function(index, item) {
                    htmlView += `
                        ...
                        <td>
                            <div class="d-flex align-items-center justify-content-center">
                                <a href="{{ url('/surat-keluar/` + item.id +`') }}"><button type="button"
                                        class="btn btn-primary btn-sm">
                                        <svg xmlns="http://www.w3.org/2000/svg" height="1em"
                                            viewBox="0 0 576 512">
                                            <style>
                                    ...
                                    <a href="{{ url('/surat-keluar/ubah/` + item.id +`') }}" class="mx-1"><button
                                            type="button" class="btn btn-warning btn-sm">
                                            <svg xmlns="http://www.w3.org/2000/svg" height="1em"
                                                viewBox="0 0 512 512">
                                                <style>
    ...
    function table_post_row_archives(res) {
        var options = {
            dataSource: res.archives,
            pageSize: 10,
            showSizeChanger: true,
            callback: function(data, pagination) {
                var htmlView = `<tr>`;
                ...
                $.each(data, function(index, item) {
                    htmlView += `
                        ...
                        <td>
                            <div class="d-flex align-items-center justify-content-center">
                                <a href="{{ url('/arsip/` + item.id +`') }}"><button type="button"
                                        class="btn btn-primary btn-sm">
                                        <svg xmlns="http://www.w3.org/2000/svg" height="1em"
                                            viewBox="0 0 576 512">
                                            <style>
                                    ...
                                    <a href="{{ url('/arsip/ubah/` + item.id +`') }}" class="mx-1"><button
                                            type="button" class="btn btn-warning btn-sm">
                                            <svg xmlns="http://www.w3.org/2000/svg" height="1em"
                                                viewBox="0 0 512 512">
                                                <style>
                                ...
                                @if (Auth::user()->role != 0)
                                    <button type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                                        data-target="#deleteArchiveModal"
