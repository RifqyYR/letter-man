...
<script>
    ...
    var authenticatedUserRole = "{{ Auth::user()->role }}";
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex align-items-center justify-content-center">
                            <a href="{{ url('/kebenaran-dokumen/` + item.id +`') }}">
                            ...
                            <a href="{{ url('/kebenaran-dokumen/ubah/` + item.id +`') }}" class="mx-1">
                        ...
                        htmlView += `
                            <a href="{{ url('/kebenaran-dokumen/cetak/` + item.id +`') }}">
