    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">Ubah Nota Dinas</h1>
            </div>
        </div>
        ...
        <div class="card mt-2">
            <div class="card-body">
                <form action="/proses-ubah-nota-dinas" method="post" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="namaSurat"
                            value="<?php echo e($officialMemo->title); ?>">
...
unset($__errorArgs, $__bag); ?>" name="tanggalPembuatan"
                            autocomplete="off" value="<?php echo e($officialMemo->created_at->toDateString()); ?>" />
...
unset($__errorArgs, $__bag); ?>"
                                name="nomorSurat" id="nomorSurat" value="<?php echo e($officialMemo->number); ?>" readonly>
...
unset($__errorArgs, $__bag); ?>"
                            id="fileNotaDinas" name="fileNotaDinas" value="<?php echo e($officialMemo->file_path); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <input type="hidden" name="id" value="<?php echo e($officialMemo->id); ?>">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\muham\Documents\Programming\project\pelindo\e-agreement\resources\views/pages/officialmemo/editofficialmemo.blade.php ENDPATH**/ ?>