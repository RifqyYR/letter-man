...
unset($__errorArgs, $__bag); ?>" name="tanggalPembuatan"
                            autocomplete="off" value="<?php echo e($news->created_at->toDateString()); ?>" />
...
unset($__errorArgs, $__bag); ?>"
                                name="nomorSurat" id="nomorSurat" value="<?php echo e($news->number); ?>" readonly>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control-file <?php $__errorArgs = ['fileBeritaAcara'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                            id="fileBeritaAcara" name="fileBeritaAcara" value="<?php echo e($news->file_path); ?>">
                        <?php $__errorArgs = ['fileBeritaAcara'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\muham\Documents\Programming\project\pelindo\e-agreement\resources\views/pages/news/editnews.blade.php ENDPATH**/ ?>