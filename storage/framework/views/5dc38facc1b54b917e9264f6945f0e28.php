...
<script>
    ...
    function search() {
        ...
        if (window.location.pathname == "/kebenaran-dokumen") {
            ...
            $.post('<?php echo e(route('archive.search')); ?>', {
                    _token: $('meta[name="csrf-token"]').attr('content'),
                    keyword: keyword
                },
                function(data) {
    ...
    var authenticatedUserName = "<?php echo e(Auth::user()->name); ?>";
    var authenticatedUserRole = "<?php echo e(Auth::user()->role); ?>";
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex align-items-center justify-content-center">
                            <a href="<?php echo e(url('/kebenaran-dokumen/` + item.id +`')); ?>">
                            ...
                            <a href="<?php echo e(url('/kebenaran-dokumen/ubah/` + item.id +`')); ?>" class="mx-1">
                        ...
                        } else if (authenticatedUserRole === "0") {
                            if (authenticatedUserName === item.created_by) {
                                htmlView += `
                                <button type="button" class="btn btn-danger btn-sm me-1" data-toggle="modal"
                                        data-target="#deleteDocumentAuthorizationLetterModal"
                                        onclick="deleteDocumentAuthorizationLetter('` + item.id + `')">
            ...
            callback: function(data, pagination) {
                ...
                $.each(data, function(index, item) {
                    htmlView += `
                        ...
                        <td>
                            <div class="d-flex align-items-center justify-content-center">
                                <a href="<?php echo e(url('/arsip/` + item.id +`')); ?>"><button type="button"
                                    ...
                                    <a href="<?php echo e(url('/arsip/ubah/` + item.id +`')); ?>" class="mx-1"><button
