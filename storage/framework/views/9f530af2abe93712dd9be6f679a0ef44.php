...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="/tambah-berita-acara" class="d-none d-sm-inline-block btn btn-sm btn-info shadow-sm">
                                        ...
                                        <div class="d-flex align-items-center justify-content-center">
                                            ...
                                            <?php if(Auth::user()->role != 0): ?>
                                                <button type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                                                    ...
                                                    onclick="deleteNews('<?php echo e($item->id); ?>')">
                                                    <svg xmlns="http://www.w3.org/2000/svg" height="1em"
                                                        viewBox="0 0 448 512">
                                                        <style>
                                                            svg {
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\muham\Documents\Programming\project\pelindo\e-agreement\resources\views/pages/news/news.blade.php ENDPATH**/ ?>