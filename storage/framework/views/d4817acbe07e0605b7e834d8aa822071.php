...
<ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item <?php echo e(Request::is('surat-keluar') ? 'active' : ''); ?>">
    ...
    <li class="nav-item <?php echo e(Request::is('kebenaran-dokumen') ? 'active' : ''); ?>">
        <a class="nav-link" href="/kebenaran-dokumen">
            <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 576 512">
                <style>
                    svg {
                        fill: #ffffff
            ...
            <span>Kebenaran Dokumen</span>
        </a>
    </li>

    
    <li class="nav-item <?php echo e(Request::is('arsip') ? 'active' : ''); ?>">
...
<!-- End of Sidebar -->
<?php /**PATH D:\APLIKASI\www\siap\resources\views/includes/sidebar.blade.php ENDPATH**/ ?>